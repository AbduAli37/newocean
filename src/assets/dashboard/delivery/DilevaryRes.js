...
const DilevaryRes = () => {
  ...
  const getdelivarydata = () => {
    axios
      .post("https://camp-coding.tech/ocean_burg/admin/select_all_order.php", JSON.stringify({status : "delivery_request"}))
      .then((res) => {
  ...
  const showmorefuncs = () => {
    return (
      <div className="showmore_func">
        ...
        <div style={{width:'100%'}} className="showmore_div">
      ...
      <Model
          ...
          children={
            <div className="cancel_div">
              <label htmlFor="">Enter Cancel Reason</label>
