 ...
 ******************************************/
  ...
  const WEIGHT_SIZE_OPtions = ["POUND", "LB"];
    ...
    <React.Fragment>
      <div className="Ground">
        <div className="info-landing">
          ...
          >
            <p>Get a Quote</p>
            <h2>TRUCKING COST CALCULATOR</h2>
        ...
        <div className="container">
          ...
          <div className="box">
            ...
            <Select
              options={Countries}
              id="origen"
              placeholder="Groundport  , Sity or Zip Code"
          ...
          {FCl_or_LCL === "FCL"
            ...
            : null}
          <button className="GroundrchRate">Groundrch Rate</button>
        </div>
      </div>
      <Footer />
    </React.Fragment>
