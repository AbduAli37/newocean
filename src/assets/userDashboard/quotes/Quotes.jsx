...
export const Quotes = () => {
  ...
  const getquotedata = () => {
    ...
    axios
      .post(
        "https://camp-coding.tech/ocean_burg/user/select_my_quotition.php",
  ...
  const handlegetrate = (id) => {
    ...
    axios
      ...
      .then((res) => {
        ...
        setgetenmoney(alldata.map((item,index)=>{
      ...
      render: (_, record) => (
        <Space>
          <span
            ...
            onClick={() => {
              navigate("/userdashboard/usershowquotedetails", {
                state: { item: record },
              });
            }}
          >
              ...
              {record.origin_type === "location" ? (
                <a href={record.link_origin_map} target="_blank">
                  <span className="loc_dest_org">
                    <span> {record.origin_location_name} </span>
                    <span>
                      {record.origin_type == "location" ? (
          ...
          {/* {console.log(record)} */}
          {
            <span id="countery_code_origin">
              {record.countery_code_origin ? (
                ...
                require("../../../../src/assets/img/flags/US.svg").default
              )}
              {record.countery_code_origin}
            </span>
          }
            ...
            <span>
              {record.destination_type === "location" ? (
                ...
                <span className="loc_dest_org">
                  ...
                  <span>
                    {
                      record.destination_type == "code" ? record.shipping_type == "air" ? (
                      <Icon icon="guidance:arrival" />
                    ) : record.shipping_type != "local" ? (
                      <Icon icon="guidance:port" />
                    ) : (
        ...
        <Space>
          {/* {console.log(record)} */}
          {
            <span id="countery_code_destination">
              {/* {console.log(record.countery_code_destination)} */}
              {record.countery_code_destination != undefined ? (
                <img
                  src={require("../../../../src/assets/img/flags/" +
                    flagdata.filter(
  ...
  const contains2 = (items, query) => {
    const { origin_location_name } = items;
  ...
  const handleChangeSelectStatus=(item,index)=>{
    let list=[...getenmoney];
  ...
  const handleNavigateToPrint=()=>{
    ...
    // let pushedArr=[];
    // for(let i=0;i<getenmoney.length;i++){
    //   if(getenmoney[i].checked){
    //     pushedArr.push(getenmoney[i]);
    //   }
    // }
    // if(pushedArr.length==0){
    //   toast.warn('First Select any Rate');
    //   return;
    // }
    // navigate("/userdashboard/printrates",{
    //   state:{
    //     selectedRates:pushedArr
    //   }
    // })
  }
          ...
          <div className="showrates">
            <div className="rates">
              ...
              </div>
              {
                    ...
                    return (
                      <div className="rate" key={index}>
                        ...
                        <div className="view_details">
                          ...
                          <button onClick={()=>{
                            handleChangeSelectStatus(item,index);
                          ...
                          <button
                            ...
                            onClick={()=>{
                              // console.log(item)
                              handleselect(rowdata,item.total_money,item);
                            }}
                          >
                            {
                              loading?
                ...
                ):(<img style={{maxWidth:'100%'}} src={require("../../img/nodata.png")} alt=""/>)
              }

              {/* <Button className='addrate'
                  onClick={() => {
                ...
                getenmoney.length>0?(
                  <button onClick={()=>{
                    handleNavigateToPrint();
                  }} className="downloadpdfbtn">download rates</button>
                ):(null)
              }
            </div>
            {makeresponse ? (
                  ...
                  <div className="quote_details">
                    ...
                    <table className="Charge_Breakdown">
                      ...
                      <tr>
                        ...
                        <td>{rowdata.ports_origin_data[0].name}</td>
                        <td>{rowdata.ports_destination_data[0].name}</td>
